...
class TestTextNode(unittest.TestCase):
    ...
    def test_repr(self):
        node = TextNode("Test Text Node", TextType.TEXT, "www.google.com")
        self.assertEqual(repr(node), "TextNode(Test Text Node, Normal Text, www.google.com)")

class TestTextNodeToHTMLNode(unittest.TestCase):
    def test_unknown_text_type(self):
        node = TextNode("This node has an invalid TextType", 0)
